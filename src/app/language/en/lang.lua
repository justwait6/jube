...
L.MONEYTREE.COPY_DESC                        = "朋友输入你的邀请码，\n你就可以获得奖励\n邀请朋友越多，获得奖励越多，\n朋友玩牌越多，获得奖励越多。"
L.MONEYTREE.CODE_NOT_EXIST                   = "邀请码不存在"
L.MONEYTREE.BIND_ERROR                       = "绑定错误"
L.MONEYTREE.INVITE_DESC                      = "通过Line FB，\n向你的朋友发送邀请"
...
L.RUMMY = {}
L.RUMMY.CHANGE_TABLE_FAIL                   = "Can not switch room in the game"
L.RUMMY.TABLE_NOT_EXIST                     = "Nonexistent Table"
L.RUMMY.TOO_MUCH_MONEY                      = "Too many coins."
L.RUMMY.STANDTIPS                           = "If you stand up now, the system will judge you lose, Are you sure to stand up？"
L.RUMMY.STR_STANDUP_NOTICE                  = "You have not operated for a long time, please take a break"
L.RUMMY.LOGIN_ERROR                         = "Login error"
L.RUMMY.TABLE_FULL                          = "No available seat"
L.RUMMY.LESS_MONEY                          = "Insufficient Chips"
L.RUMMY.WAIT_FOR_CHGTABLE                   = "Switching table..."
L.RUMMY.EXITTIPS                            = "Are you sure to quit this round of game?"
L.RUMMY.FOLDED                              = "Dropped"
L.RUMMY.STR_STANDUP_TIP                     = "Please take a break"
L.RUMMY.GAME_START_COUNTDOWN_FMT            = "New round will start in %s seconds"
L.RUMMY.EXIT_ROOM_TIP                       = "Are you sure to quit this round?"
L.RUMMY.STR_NOT_TABLE                       = "Please switch to another table"
L.RUMMY.RULE_TITLE                          = "Rules"
L.RUMMY.SWITCH_TABLE                        = "Switch Table"
L.RUMMY.OPEN_DECK                           = "OPEN\nDECK"
L.RUMMY.CLOSED_DECK                         = "CLOSED\nDECK"
L.RUMMY.FINISH_SLOT                         = "FINISH\nSLOT"
L.RUMMY.NEW_GROUP                           = "NEW\nGROUP"
L.RUMMY.CONFIRM_FINISH_TIPS                 = "Are you sure to finish?"
L.RUMMY.USER_NAME                           = "username"
L.RUMMY.RESULT                              = "Result"
L.RUMMY.CARDS                               = "Cards"
L.RUMMY.POINTS                              = "points"
L.RUMMY.TOTAL_SCORE                         = "Total\nScore"
L.RUMMY.WAITING                             = "Waiting.."
L.RUMMY.LOST                                = "Lost"
L.RUMMY.WINNER                              = "Winner"
L.RUMMY.DROPPED                             = "Dropped"
L.RUMMY.AWAY                                = "Away"
L.RUMMY.STRAIGHT_FLUSH                      = "Pure Sequence"
L.RUMMY.STRAIGHT                            = "Sequence"
L.RUMMY.SANGONG                             = "Set"
L.RUMMY.POINTS_RUMMY                        = "Points Rummy"
L.RUMMY.BALANCE                             = "Balance"
L.RUMMY.CLICK_HERE                          = "Click Here"
L.RUMMY.LEAVE_TABLE                         = "LEAVE TABLE"
L.RUMMY.SCORE_WINDOW_DECLARE_COUNT          = "Declare is in progress please for other players to declare %s Second(s)"
L.RUMMY.VIEW_RESULT_TIP                     = "Please wait for all the players to declare. To view the result screen"
L.RUMMY.WAIT_NEXT_GAME_TIP                  = "Please wait for next round ..."
L.RUMMY.TURN_TO_PLAY_FMT                    = "%s's turn to play."
L.RUMMY.DRAW_CART_TIP_1_FMT                 = "%s has draw a card from open deck."
L.RUMMY.DRAW_CART_TIP_2_FMT                 = "%s has draw a card from closed deck."
L.RUMMY.USE_BONUS_TIME_FMT                  = "%s is using bonus time."
L.RUMMY.I_AM_BACK                           = "I AM BACK"
L.RUMMY.I_AM_BACK_TIP                       = "Missed %s turn before being dropped from the game."
L.RUMMY.GAME_TYPE                           = "Game Type: %s"
L.RUMMY.POINT_VALUE                         = "Point Value: %s"
L.RUMMY.NUMBER_OF_DECKS                     = "Number Of Decks: %s"
